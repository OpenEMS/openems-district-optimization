...
Optimierung <- function(Profil_PV_Ost,
      ...
      x_fuel_price["Umgebung_PubGfuel1","Umgebung_GaBo1",] <- 0.581+100000; # Gaspreis + CO2-Emissionen * CO2-Preis   0.2*10000 #
      #
      #fuel Verbindungen Gas_Netz -> BHWK
      x_fuel["Umgebung_PubGfuel1","Umgebung_CHP1"] <- -1;
      x_fuel_eff["Umgebung_PubGfuel1","Umgebung_CHP1"] <- 1;
      x_fuel_price["Umgebung_PubGfuel1","Umgebung_CHP1",] <- 0.581; # Gaspreis + CO2-Emissionen * CO2-Preis   0.2 #
      #
      #
