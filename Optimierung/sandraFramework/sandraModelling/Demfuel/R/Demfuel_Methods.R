...
#'load_fuel
#'
#'Get the fuel load on timegrid in kW. The timeseries on the 15 minute timegrid
#'is brougth to the one minute timegrid by considering minute values constant
#'on a 15 minute block. Then the timeseries is brought to timegrid by taking
#'means
#'
...
setMethod("load_fuel", signature(object = "Demfuel"), function(object) {
